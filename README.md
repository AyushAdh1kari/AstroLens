...
Dataset size for each individual object is determined by the number of verifiable photos taken, angles/prespectives of said photos, as well as general "uniqueness" of a Celestial object's external attributes.
...
**Model 2: SpaceNet Deep-Sky Classification created**
...
AstroLens includes key Moon analysis information, gated by a Solar System classifier to ensure accurately. If the model detects an image as the Moon with high confidence, the following tools are unlocked:
...
**Crater Detection**
Uses a custom OpenCV pipeline which enhances contrast and applies circular hough translations into likely craters, as well as returning the total count of craters in an image.

**Image Ehancement**
Pre-processing improves clarity by using noise neduction, histogram equalization, and sharpening filters.
...
- Use OpenCV for crater detection, crater count, moon enhancement
...
- Planets and Moons dataset (Kaggle) currently being used, although I am currently creating my own dataset for more precise + additional objects not included
- Citation list for custom dataset is included in docs, Will cite all resources used in the final app
- Images and Dataset are **NOT** being redistributed in this repository for licensing restrictions and ethical computing purposes.
